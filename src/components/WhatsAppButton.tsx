  ...
  return (
    <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50">
      ...
      <button
        ...
        className="group relative bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 animate-pulse hover:animate-none ripple-effect"
        style={{
      ...
      >
        ...
        <svg 
          ...
          className="sm:w-8 sm:h-8 transition-transform duration-300 group-hover:scale-110 animate-wiggle relative z-10"
        >
          <path 
        ...
        <div className="hidden sm:block absolute right-full mr-3 top-1/2 transform -translate-y-1/2 bg-white text-gray-800 px-3 py-1 rounded-md shadow-md opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap pointer-events-none text-sm z-20">
          تواصل معنا
          {/* السهم */}
