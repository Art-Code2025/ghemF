...
const App: React.FC = () => {
  ...
  <footer className="relative bg-gradient-to-br from-white via-gray-50 to-gray-100 py-6 sm:py-8 lg:py-10 border-t border-gray-200/60 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative bg-gradient-to-r from-white/60 via-gray-50/80 to-white/60 backdrop-blur-2xl border border-gray-200/60 rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 lg:mb-8 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-50/20 via-purple-50/20 to-pink-50/20" />
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-blue-200/30 to-purple-200/30 rounded-full blur-2xl" />
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-pink-200/30 to-orange-200/30 rounded-full blur-2xl" />
            
            <div className="relative text-center">
              <h3 className="text-lg sm:text-xl font-black bg-gradient-to-r from-gray-700 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-3 sm:mb-4">
                تابعنا على السوشيال ميديا
              </h3>
              <div className="h-0.5 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-400 rounded-full mb-4 sm:mb-6 w-20 sm:w-24 mx-auto shadow-lg" />
              ...
              <div className="flex justify-center items-center gap-3 sm:gap-4 lg:gap-6">
                ...
                <a 
                  ...
                  className="group relative w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center shadow-lg hover:shadow-2xl transform hover:scale-110 hover:rotate-3 transition-all duration-500 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-400/50 to-blue-800/50 rounded-2xl blur-sm group-hover:blur-none transition-all duration-300" />
                  <div className="absolute inset-0 bg-white/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300" />
                  <svg className="relative w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-20 blur-lg transition-all duration-500" />
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group relative w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 rounded-2xl flex items-center justify-center shadow-lg hover:shadow-2xl transform hover:scale-110 hover:rotate-3 transition-all duration-500 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-400/50 via-red-400/50 to-yellow-400/50 rounded-2xl blur-sm group-hover:blur-none transition-all duration-300" />
                  <div className="absolute inset-0 bg-white/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300" />
                  <svg className="relative w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="absolute -inset-1 bg-gradient-to-r from-pink-400 via-red-400 to-yellow-400 rounded-2xl opacity-0 group-hover:opacity-20 blur-lg transition-all duration-500" />
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group relative w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl flex items-center justify-center shadow-lg hover:shadow-2xl transform hover:scale-110 hover:rotate-3 transition-all duration-500 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-yellow-300/50 to-yellow-700/50 rounded-2xl blur-sm group-hover:blur-none transition-all duration-300" />
                  <div className="absolute inset-0 bg-white/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300" />
                  <svg className="relative w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="absolute -inset-1 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-2xl opacity-0 group-hover:opacity-20 blur-lg transition-all duration-500" />
                </a>
              </div>
              
              <p className="text-xs sm:text-sm text-gray-600 mt-3 sm:mt-4 font-medium">
                اتبعنا للحصول على آخر العروض والمنتجات الجديدة
              </p>
            </div>
          </div>
